...
@Data
public class ContractPlanUpdate {

	@ApiModelProperty(required = true, value = "사이트ID (국가코드(2)+City코드(5)+년도(4)+월(2)+일련번호(5))")
...
//	@ApiModelProperty(value = "계약정보첨부파일")
//	private MultipartFile[] constractMultipartFile;
//	@ApiModelProperty(value = "계획수립첨부파일")
//	private MultipartFile[] planMultipartFile;

	@ApiModelProperty(value = "계약첨부파일ID")
	private String[] fileIdCd1;
	@ApiModelProperty(value = "계획첨부파일ID")
